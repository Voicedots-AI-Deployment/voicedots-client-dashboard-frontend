...
export const phoneAgentsApi={
 ...
 async savePrompt(id:string,first_message:string,system_prompt:string){return (await apiClient.put(`/v3/phone-agents/${id}/prompt`,{first_message,system_prompt})).data},
};
