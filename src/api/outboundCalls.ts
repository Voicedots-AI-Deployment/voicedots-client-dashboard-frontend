...
export const outboundCallsApi={
 ...
 create:async(data:{phone_agent_id:string;destination:string;contact_name:string;consent_confirmed:boolean})=>(await apiClient.post('/v3/outbound-calls',data)).data,
