...
function KpiCard({
  ...
  return (
    <div
      className={`bg-[#161722] border ${style.border} rounded-2xl px-6 py-5 flex items-center gap-5 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/5 hover:-translate-y-0.5`}
    >
